...
風險識別   自然災害和一些常見風險。羅列出組織所有面臨的風險
可能性評估 要先確定年度發生率ARO來簡化不同風險規模比較
影響分析   具體指標: 暴露因子EF、單一損失期望SLE(AV*EF)和年度損失期望ALE(SLE*ARO)，對每個特定風險資產組合
資源優先級排序
