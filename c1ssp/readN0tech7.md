...
-傳輸模式transport、端到端加密只加密數據包的堆等通信
-隧道模式tunnel、加密包括報頭哪整個數據包的鏈路加密
...
1.已知明文 掌握加密消息副本和用於生成密文消息，破解弱代碼
2.選擇明文 選擇一組明文對應的密文，嘗試提取密鑰 差異分析的明文攻擊
3.選擇密文 能夠解密密文被選中部分消息發現密鑰
4.中間相遇 兩輪加密算法2DES被棄用改用3DES，已知明文可能被k1加密然後再用可能k2解密．因為只是單輪加密
5.中間人  攔截所有通信 冒用原發者與預期接收第二安全對話，可讀取通信參與之前所有訊息．又稱路徑攻擊
6.生日    碰撞攻擊(collision attack)尋求哈希函數
7.重放
8.
-
-
